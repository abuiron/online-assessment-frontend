...
import '../../../stylesheets/addexam.css'
      ...
      children: (
        <>
          <div className='flex justify-end'>
            <button className="primary-outlined-btn cursor-pointer" type="button"
      ...
      {(examData || !id) && (
        <Form layout="vertical" onFinish={onFinish} initialValues={examData} className="mt-2">
          ...
          <div className='flex justify-end gap-2 mt-4'>
            ...
            <button className='primary-contained-btn w-15 cursor-pointer' onClick={() => navigate('/admin/exams')}>
              Cancel
            </button>
          </div>
        </Form>
